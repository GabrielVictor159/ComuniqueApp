        ...
        <View style={styles.CadastrarStyle.viewMiddle}>
          <View style={styles.CadastrarStyle.viewInputs}>
            <View style={styles.CadastrarStyle.selectCategoria}>
              <Pressable
                style={
                  this.state.categoria === "Aluno"
                    ? styles.CadastrarStyle.selectActive
                    : styles.CadastrarStyle.selectInative
                }
                onPress={() => this.setState({ categoria: "Aluno" })}
              >
                <Text>Aluno</Text>
              </Pressable>
              <Pressable
                style={
                  this.state.categoria === "Professor"
                    ? styles.CadastrarStyle.selectActive
                    : styles.CadastrarStyle.selectInative
                }
                onPress={() => this.setState({ categoria: "Professor" })}
              >
                <Text>Professor</Text>
              </Pressable>
            </View>
            <Text>{"\n"}</Text>
            <TextInput
              style={styles.CadastrarStyle.input}
