      ...
      const fetchData = async () => {
        try {
          ...
          if (response.ok) {
            ...
            setContatos((contatos) => [...contatos, ...filteredItems]);
  ...
  function mapContatosDaUnidade() {
    ...
    if (contatos.length !== 0) {
      return contatos.filter(post => {
        ...
        let a = 0;
        props.chats.forEach(value2 => {
          if (value2.usuario1.idUsuario === value.idUsuario || value2.usuario2.idUsuario === value.idUsuario) {
            a++;
          }
        })
        if (a === 0) {
          return (
            <View style={{ width: '100%', alignItems: 'center' }} key={value.idUsuario}>
      ...
      <View style={styles.menu}>
        ...
        <View style={styles.inputContainer}>
          ...
          <View style={styles.lupaContainer}>
            <Image style={{ width: 30, height: 30 }} source={require("../../../assets/Lupa.png")} />
          </View>
