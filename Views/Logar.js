...
export default class Logar extends React.Component{
    ...
    >
        ...
        <Button1 width={220} height={55} borderRadius={20} fontSize={20} tipoNavegacao='push' navegacao='PaginaUsuario'  texto='Logar' color1={cores.buttonGradientColor1} color2={cores.buttonGradientColor2}/>
              <Link
