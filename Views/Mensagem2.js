    ...
    return (
      ...
      >
        ...
        <View style={styles.Mensagem2Style.TextContainer}>
          <Text style={styles.Mensagem2Style.Mensagem}>
            Nesse app comunicação será feita através de imagens e figuras, para
            que tudo seja bem mais amigável
          </Text>
        </View>
        <NavigationMensagens
          screenNumber={2}
