    ...
    return (
      ...
      >
        <Button1
          ...
          navegacao={props.navigationButton1}
          fontSize={15}
          texto={props.button1Text}
          color1={props.buttonColor1}
          color2={props.buttonColor2}
        />
        <View
          style={{
            width: "20%",
        ...
        >
          <View
            style={{
              backgroundColor: props.buttonColor1,
              width: 25,
              height: 25,
              borderRadius: 20,
            }}
        ...
        <Button1
          ...
          borderRadius={20}
          tipoNavegacao="navigate"
          navegacao={props.navigationButton2}
          fontSize={15}
          texto={props.button2Text}
          color1={props.buttonColor1}
          color2={props.buttonColor2}
        />
      </View>
