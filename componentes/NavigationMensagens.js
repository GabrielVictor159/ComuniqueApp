...
const NavigationMensagens = (props)=>{
    if(props.screenNumber==1){
        return (
            ...
            <Button1 width={'28%'} height={'100%'} borderRadius={20} navegacao={props.navigationButton1} fontSize={15}  texto={props.button1Text} color1={props.buttonColor1} color2={props.buttonColor2}/>
            ...
            <Button1 width={'28%'} height={'100%'} borderRadius={20} navegacao={props.navigationButton2}  fontSize={15}  texto={props.button2Text} color1={props.buttonColor1} color2={props.buttonColor2}/>
            </View>
        );
    }
